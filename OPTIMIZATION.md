...
Expanding the link text to “my GitHub” leaves the visible sentence and raw HTML size unchanged. The updated build is 321 bytes with Brotli, 468 with gzip and 456 with deflate; the [new measurements](measurements/page-20260926-link-label.json) keep that edit separate from the earlier visual-equivalence results. The [September 26 deployment record](measurements/deployment-20260926.json) verifies this version on Alfred.
