...
for(const protocol of ['--http1.1','--http2']) {
 ...
 for(const [path,status,location,method,origin] of [
  ['/c',301,'mailto:tomkimberlin@gmail.com'],['/m',301,'https://github.com/tomkimberlin/m365-workbench'],['/i',301,'https://github.com/tomkimberlin/Save-Image-As'],['/w',301,'https://euthenics.com/'],['/e',301,'https://euthenics.com/'],['/g',301,'https://github.com/tomkimberlin'],['/p',301,'https://paste.kimberlin.net/'],['/k',301,'https://1kb.club/'],['/t',404],['/x',301,'https://xmr.surf/'],['/s',301,'https://github.com/tomkimberlin/1kb-website'],['/index.html',301,'/'],['/index.html?a=1',301,'/?a=1'],['/missing',404],['/index.html.br',404],['/Caddyfile',404],['/.well-known/onekb-connectivity',404],['/',405,undefined,'POST'],['/?a=1',301,'https://tomkimberlin.com/?a=1','GET','http://tomkimberlin.com'],['/?a=1',301,'https://tomkimberlin.com/?a=1','GET','https://www.tomkimberlin.com']]) {
